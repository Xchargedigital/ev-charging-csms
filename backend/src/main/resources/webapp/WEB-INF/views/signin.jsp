...
<html>
<head>
	<link rel="icon" href="${ctxPath}/static/images/XLogoPurpleGradient.png" type="image/x-icon" />
	<link rel="shortcut icon" href="${ctxPath}/static/images/XLogoPurpleGradient.png" type="image/x-icon" />
	<link rel="stylesheet" type="text/css" href="${ctxPath}/static/css/style.css">
	<title>XCharge Digital</title>
</head>
<body>
<div class="main">
<div class="top-banner"><div class="container"><a href="${ctxPath}/manager/home"><img src="${ctxPath}/static/images/XChargePurple.png" height="80"></a></div></div>
