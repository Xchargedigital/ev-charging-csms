...
<div class="content">
<section><span>About XCharge Digital CMS</span></section>
...
<table class="userInputFullPage">
	<tr><td>Version:</td><td>1.0.4</td></tr>
...
<section><span>Endpoint Info</span></section>
    <table class="userInputFullPage">
        ...
        <tr>
            ...
            <td>ws://cms.xcharge-digital.com:8080/xcharge/websocket/csms/(chargeBoxId)</td>
        </tr>
