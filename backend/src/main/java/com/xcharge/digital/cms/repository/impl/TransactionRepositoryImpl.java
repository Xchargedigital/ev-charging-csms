...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    public List<Transaction> getTransactions(Base form) {
        return getMeterValues(form).fetch()
                .map(new TransactionMapper());
    }
    ...
    private SelectQuery addConditions(SelectQuery selectQuery, Base form) {

        selectQuery.addConditions(TRANSACTION.CHARGE_BOX_ID.eq(form.getChargeBoxId()));

        selectQuery.addConditions(TRANSACTION.ID_TAG.eq(form.getIdTag()));
